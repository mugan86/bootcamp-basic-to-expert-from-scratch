...
class TestCoordinates(TestCase):
    ...
    def test_coordinates_ok(self, mock_response):
        ...
        coordinates.get_data.return_value = {'coord': {'lon': -2.2879, 'lat': 43.1995}, 'weather': [{'id': 804, 'main': 'Clouds', 'description': 'nubes', 'icon': '04d'}], 'base': 'stations', 'main': {'temp': 15.23, 'feels_like': 14.71, 'temp_min': 13.92, 'temp_max': 18.97, 'pressure': 1017, 'humidity': 73, 'sea_level': 1017, 'grnd_level': 917}, 'visibility': 10000, 'wind': {'speed': 1.67, 'deg': 145, 'gust': 2.09}, 'clouds': {'all': 94}, 'dt': 1634486404, 'sys': {'type': 2, 'id': 2001916, 'country': 'ES', 'sunrise': 1634451908, 'sunset': 1634491410}, 'timezone': 7200, 'id': 6325251, 'name': 'Santa Kurutz', 'cod': 200}
